	...
	<div class="container">
    	<form method="post" class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<select class="form-control" name="system" id="system" disabled="disabled">
						<%
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<select class="form-control" name="processor" id="processor" disabled="disabled">
						<%
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input class="form-control" type="number" name="level" id="level" max="3" min="1"
						value="<%out.print(ticket.getLevel());%>"  disabled="disabled" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" name="sender_name" id="sender_name"
						value="<%out.print(ticket.getSender_name());%>" disabled="disabled" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" name="business_impact" id="business_impact"
						value="<%out.print(ticket.getBusiness_impact());%>" disabled="disabled" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" type="text" name="steps_to_rep" id="steps_to_rep"
						value="<%out.print(ticket.getSteps_to_rep());%>" disabled="disabled" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<a href="Ticket?id=<%out.print(ticket.getId());%>&edit=1">Edit</a>&nbsp;|&nbsp;<a href="TicketList">Back</a>
				</div>
			</div>
		</form>
	</div>
