package com.kota.stratagem.webservice.filter;
...
@WebFilter(filterName = "StratagemCrossOriginRequestFilter", urlPatterns = { "/*" })
public class StratagemCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(StratagemCrossOriginRequestFilter.class);
