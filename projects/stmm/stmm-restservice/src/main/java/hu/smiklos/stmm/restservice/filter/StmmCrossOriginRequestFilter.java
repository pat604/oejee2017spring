package hu.smiklos.stmm.restservice.filter;
...
@WebFilter(filterName = "StmmCrossOriginRequestFilter", urlPatterns = { "/*" })
public class StmmCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(StmmCrossOriginRequestFilter.class);
