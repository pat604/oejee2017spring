 ...
 */
public class LoanOfferForRestStub implements Serializable {
    ...
    public LoanOfferForRestStub(double amount, double repayment_amount,String repayment_type, double cost_of_loan, double number_repayment_unit) {
        this.amount = amount;
