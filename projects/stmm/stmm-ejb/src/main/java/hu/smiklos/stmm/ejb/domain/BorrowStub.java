...
public class BorrowStub {
    ...
    private int getRepaymentDurationTo = 300;
    ...
    public int getGetRepaymentDurationTo() {
        return getRepaymentDurationTo;
    }

    public void setRepaymentDurationTo(int getRepaymentDurationTo) {
        this.getRepaymentDurationTo = getRepaymentDurationTo;
    }
    ...
    public boolean isValid(){
        ...
        if(!(borrowAmount > 0)){
            errors.add(BorrowStub.BORROW_AMOUNT,"No amount given.");
        }
