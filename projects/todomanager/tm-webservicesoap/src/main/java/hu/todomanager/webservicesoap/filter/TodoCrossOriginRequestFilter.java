package hu.todomanager.webservicesoap.filter;
...
@WebFilter(filterName = "TodoCrossOriginRequestFilter", urlPatterns = { "/*" })
public class TodoCrossOriginRequestFilter implements Filter {

	private static final Logger LOGGER = Logger.getLogger(TodoCrossOriginRequestFilter.class);
